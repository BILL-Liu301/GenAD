...
description_with_bev = True
description_with_map = True
description_with_motion = True
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        description_with_bev=description_with_bev,
        description_with_map=description_with_map,
        description_with_motion=description_with_motion,
